    ...
    <CloseIcon />
        ...
        <div className="flex justify-between items-center mt-4">
          ...
          <div className="flex items-center border px-3 py-1 rounded-md">
            <button onClick={() => handleQuantityChange(-1)} className="px-2">
              -
            </button>
              ...
              >
                ...
                <div className="flex items-center">
                  ...
                  <input
                    ...
                    checked={
                      selectedAddons[addonCategory.category]?.some(
        ...
        >
           <div className="w-6 h-6 bg-white text-cyan-800 flex items-center justify-center rounded text-xl">
            +
           </div>
